...
class Licenses {
	...
	class TobaccoLeaf {
        ...
        displayName = "STR_License_TobaccoLeaf";
        price = 20000;
        illegal = true;
        side = "civ";
    };
	...
	class Marbles {
        variable = "Marbles";
        displayName = "STR_License_Marbles";
        price = 5000;
        illegal = false;
        side = "civ";
    };
