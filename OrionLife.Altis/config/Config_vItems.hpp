class VirtualShops {
    ...
    class med_market {
        ...
        side = "med";
        conditions = "";
        items[] = { "debitcard", "bandages", "morphine", "flashlight", "waterBottle", "rabbit", "apple", "redgull", "tbacon", "toolkit", "fuelFull", "peach", "defibrillator", "gokart"};
    };
...
/*Not in Use
	...
	class kidney {
		variable = "kidney";
		displayName = "life_inv_kidney";
		weight = 15;
		buyPrice = 7000;
		sellPrice = 5000;
		illegal = true;
		edible = -1;
		icon = "STR_Item_uraniumU";
	};
...
*/
	...
	class goldcoin {
		...
		illegal = false;
		edible = -1;
		icon = "images\icons\ico_goldcoin.paa";
	};
...
*/
	...
	class Btip {
        ...
        illegal = true;
        edible = -1;
        icon = "images\icons\boxcraftaddon\Bullet_Tip.paa";
	};
	class BShell {
        variable = "BShell";
        ...
        illegal = true;
        edible = -1;
        icon = "images\icons\boxcraftaddon\Bullet_Shell.paa";
	};
	class BPrimer {
        variable = "BPrimer";
        ...
        illegal = true;
        edible = -1;
        icon = "images\icons\boxcraftaddon\Bullet_Primer.paa";
	};
	class BPowder {
        variable = "BPowder";
        ...
        illegal = true;
        edible = -1;
        icon = "images\icons\boxcraftaddon\Bullet_Powder.paa";
	};
	class Tobaccoleaf {
        variable = "Tobaccoleaf";
        displayName = "STR_Item_Tobaccoleaf";
        weight = 4;
        buyPrice = -1;
        sellPrice = -1;
        illegal = false;
        edible = -1;
        icon = "images\icons\boxtobaccoaddon\Tobacco_Leaf.paa";
	};
	class Tobacco {
        variable = "Tobacco";
        ...
        illegal = false;
        edible = -1;
        icon = "images\icons\boxtobaccoaddon\Tobacco.paa";
	};
	class Cigar {
        variable = "Cigar";
        ...
        illegal = true;
        edible = -1;
        icon = "images\icons\boxtobaccoaddon\Cigar.paa";
	};
	class Bong {
        variable = "Bong";
        displayName = "STR_Item_Bong";
        weight = 10;
        buyPrice = 50000;
        sellPrice = 30250;
        illegal = false;
        edible = -1;
        icon = "images\icons\boxglassblowingaddon\bong.paa";
	};
	class Marbles {
        variable = "Marbles";
        displayName = "STR_Item_Marbles";
        weight = 1;
        buyPrice = 4500;
        sellPrice = 600;
        illegal = false;
        edible = -1;
        icon = "images\icons\boxglassblowingaddon\marbles.paa";
	};
	class Pipe {
        variable = "Pipe";
        ...
        illegal = false;
        edible = -1;
        icon = "images\icons\boxglassblowingaddon\pipe.paa";
	};
	class Vase {
        variable = "Vase";
        displayName = "STR_Item_Vase";
        weight = 5;
        buyPrice = 30000;
        sellPrice = 14550;
        illegal = false;
        edible = -1;
        icon = "images\icons\boxglassblowingaddon\vase.paa";
	};
	//Box's Additons
