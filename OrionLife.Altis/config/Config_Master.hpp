...
/* Database Related Settings */
    ...
    saved_virtualItems[] = { "relic1","relic2","relic3","relic4","morphine","relicTransport","relicFed","oilSupplies","speedbomb","excavator","knife","cyanideCapsule","pdrill","uraniumU","fueldart","mushrooms","LSD","rubyU","rubyC","lumber","airhorn","dogwhistle","flashlight","head","gpstracker","campfire","gokart","tent1","protest","volleyball","prize","donatorcrate","uranium","timber","axe","pliers","barrel","butt","sight","trigger","engine","plans","rubberU","rubber","goldcoin","nitromine","C4","steel","steelplate","wool","cloth","sulfur","gunpowder","doritos","pepsi","cocacola","monsterEnergy","shittynoodles","kfc","easterEggs","beer","whiskey","moonshine","debitcard","codeCracker","zipties","blindfold","counterfitCash","cprKit","panicbutton","bandage","pickaxe","defibrillator","toolkit","fuelEmpty","fuelFill","spikeStrip","lockpick","handcuffs","keys","blastingCharge","demolitioncharge","boltcutter","defusekit","storageSmall","storageBig","furniturewoodtable","furnituretarget","furnitureportgen","furniturefmradio","furniturewoodblue","furnituremetalrack","furniturePalletVert","furnitureMapAltis","furnitureTentA","furnitureSunChairGreen","furnitureSunChair","furnitureSleepingBagBrown","furnitureSleepingBagBlue","furnitureSleepingBag","furniturecampingtable","furnitureopenlaptop","furniturebagshort","furniturechair","furnituredesk","oilUnprocessed","oilProcessed","copperUnrefined","copperRefined","ironUnrefined","ironRefined","saltUnrefined","saltRefined","sand","glass","diamondUncut","diamondCut","rock","cement","heroinUnprocessed","heroinProcessed","cannabis","marijuana","cocaineUnprocessed","cocaineProcessed","redgull","coffee","waterBottle","apple","peach","tbacon","donuts","rabbitRaw","rabbit","salemaRaw","salema","ornateRaw","ornate","mackerelRaw","mackerel","tunaRaw","tuna","mulletRaw","mullet","catsharkRaw","catshark","turtleRaw","turtleSoup","henRaw","hen","roosterRaw","rooster","sheepRaw","sheep","goatRaw","goat","Btip","BShell","BPrimer","Tobaccoleaf","Tobacco","Cigar","Bong","Marbles","Pipe","Vase" }; //Array of virtual items that can be saved on your player.
    ...
    save_vehicle_items[] = { "relic1","relic2","relic3","relic4","morphine","relicTransport","relicFed","oilSupplies","speedbomb","excavator","knife","cyanideCapsule","pdrill","uraniumU","fueldart","mushrooms","LSD","rubyU","rubyC","lumber","airhorn","dogwhistle","flashlight","head","gpstracker","campfire","gokart","tent1","protest","volleyball","prize","donatorcrate","uranium","timber","axe","pliers","barrel","butt","sight","trigger","engine","plans","rubberU","rubber","goldcoin","nitromine","C4","steel","steelplate","wool","cloth","sulfur","gunpowder","doritos","pepsi","cocacola","monsterEnergy","shittynoodles","kfc","easterEggs","beer","whiskey","moonshine","debitcard","codeCracker","zipties","blindfold","counterfitCash","cprKit","panicbutton","bandage","pickaxe","defibrillator","toolkit","fuelEmpty","fuelFill","spikeStrip","lockpick","handcuffs","keys","blastingCharge","demolitioncharge","boltcutter","defusekit","storageSmall","storageBig","furniturewoodtable","furnituretarget","furnitureportgen","furniturefmradio","furniturewoodblue","furnituremetalrack","furniturePalletVert","furnitureMapAltis","furnitureTentA","furnitureSunChairGreen","furnitureSunChair","furnitureSleepingBagBrown","furnitureSleepingBagBlue","furnitureSleepingBag","furniturecampingtable","furnitureopenlaptop","furniturebagshort","furniturechair","furnituredesk","oilUnprocessed","oilProcessed","copperUnrefined","copperRefined","ironUnrefined","ironRefined","saltUnrefined","saltRefined","sand","glass","diamondUncut","diamondCut","rock","cement","heroinUnprocessed","heroinProcessed","cannabis","marijuana","cocaineUnprocessed","cocaineProcessed","redgull","coffee","waterBottle","apple","peach","tbacon","donuts","rabbitRaw","rabbit","salemaRaw","salema","ornateRaw","ornate","mackerelRaw","mackerel","tunaRaw","tuna","mulletRaw","mullet","catsharkRaw","catshark","turtleRaw","turtleSoup","henRaw","hen","roosterRaw","rooster","sheepRaw","sheep","goatRaw","goat","Btip","BShell","BPrimer","Tobaccoleaf","Tobacco","Cigar","Bong","Marbles","Pipe","Vase"  };
...
/* System Settings */
    /* ATM & Federal Reserve/Bank System Configurations */
    ...
    paycheck_cop = 8250; //Payment for cops
    paycheck_civ = 5250; //Payment for civillians
    paycheck_med = 8250; //Payment for medics
    ...
    vehicleShop_rentalOnly[] = { "B_MRAP_01_hmg_F", "B_T_LSV_01_armed_F", "O_T_LSV_02_armed_F", "B_G_Offroad_01_armed_F", "B_Boat_Armed_01_minigun_F", "O_G_Offroad_01_armed_F"	}; //Vehicles that can only be rented and not purchased. (Last only for the session)
