...
if(FETCH_CONST(life_adminlevel) < 1) then {
    ...
    /*switch (_code) do {
        //F1
        case 59: {
            createDialog "Flabby_Admin_Main";

			//Button 1
			((findDisplay 69169) displayCtrl 2400) ctrlSetStructuredText parseText format["<t size='3.5'><img image='images\textures\Admin\Spectate.paa' /></t>"];
			((findDisplay 69169) displayCtrl 2400) ctrlSetEventHandler['ButtonClick','
			if(isNil {profileNamespace getVariable "Admin_Selected"}) exitWith{};
			call AdminStartSpectate;'];
        };
        //F2
        case 60: {
            createDialog "Flabby_Admin_Main";
...
switch (_code) do {
    ...
    case 38: {
        ...
        if (_shift) then {
            if (!(isNull objectParent player) && (typeOf vehicle player) in ["C_Offroad_01_F","B_MRAP_01_F","C_SUV_01_F","C_Hatchback_01_sport_F","B_Heli_Light_01_F","B_Heli_Transport_01_F","I_G_Offroad_01_F","C_Offroad_02_unarmed_F","B_T_LSV_01_unarmed_F","B_LSV_01_unarmed_F","B_CTRG_LSV_01_light_F","I_MRAP_03_F","B_T_LSV_01_unarmed_black_F","C_Offroad_02_unarmed_black_F","C_Van_01_box_F"]) then {
