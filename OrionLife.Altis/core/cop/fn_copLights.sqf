...
switch (_type) do
{
	...
	case "I_MRAP_03_F":
	{
        ...
        [true, "blue", [0.8, 2.4, -0.4]] call _attach;
        [true, "red", [1.1, -3.0, 0.277]] call _attach;
        [false, "blue", [-1.1, -3.0, 0.277]] call _attach;
        [true, "white", [-0.8, 2.4, -0.4]] call _attach;
        [false, "white", [0.8, 2.4, -0.4]] call _attach;
    };
	
	case "B_T_LSV_01_unarmed_black_F":
	{
        [false, "red", [0.9, 0.6, -0.15]] call _attach;
        [true, "blue", [0.9, -0.8, -0.15]] call _attach;
        [true, "red", [-0.85, -0.8, -0.15]] call _attach;
        [false, "blue", [-0.85, 0.6, -0.15]] call _attach;
        [true, "white", [0.9, 0.6, -0.15]] call _attach;
        [false, "white", [0.9, -0.8, -0.15]] call _attach;
    };


	case "C_Offroad_02_unarmed_black_F":
	{
        [false, "red", [-0.85, 1.82, -0.34]] call _attach;
        [true, "blue", [0.76, 1.82, -0.34]] call _attach;
        [true, "red", [0.65, -1.554, -0.22]] call _attach;
        [false, "blue", [-0.75, -1.554, -0.22]] call _attach;
        [true, "white", [-0.85, 1.82, -0.34]] call _attach;
        [false, "white", [0.76, 1.82, -0.34]] call _attach;
    };
	
	case "B_Quadbike_01_F":
	{
        [false, "red", [0.155, 0.951, -0.6]] call _attach;
        [true, "blue", [-0.17, 0.951, -0.6]] call _attach;
        [true, "red", [0.4, -1.05, -0.425]] call _attach;
        [false, "blue", [-0.45, -0.85, -0.4]] call _attach;
        [true, "white", [0.155, 0.951, -0.6]] call _attach;
		[false, "white", [-0.17, 0.951, -0.6]] call _attach; 
    };
	
	case "B_GEN_Van_02_vehicle_F":
	{
        [false, "red", [0.8, 1.694, -1.60]] call _attach;
        [true, "blue", [-0.7, 1.691, -1.60]] call _attach;
        [true, "red", [0.8, -2.906, -1.655]] call _attach;
        [false, "blue", [-0.8, -2.91, -1.655]] call _attach;
        [true, "white", [0.8, 1.694, -1.60]] call _attach;
        [false, "white", [-0.7, 1.691, -1.60]] call _attach;
    };
