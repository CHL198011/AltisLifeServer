...
if (_action) then {
    if (findLocalVehicle < _upgradePrice) exitWith {
        hint parseText format [
            ...
            [findLocalVehicle] call life_fnc_numberText,
            [_upgradePrice - findLocalVehicle] call life_fnc_numberText
        ];
    };
    findLocalVehicle = findLocalVehicle - _upgradePrice;
