...
private _vaultHouse = [[["Altis", "Land_Cargo_House_V4_F"], ["Malden", "Land_Cargo_House_V4_F"], ["Tanoa", "Land_Medevac_house_V1_F"]]] call TON_fnc_terrainSort;
private _altisArray = [13065.389,15355.379,6.464]; //NEED TO CHANGE
...
if (life_HC_isActive) then {
    [getPlayerUID player,profileName,"218"] remoteExecCall ["HC_fnc_wantedAdd",HC_Life];
} else {
    [getPlayerUID player,profileName,"218"] remoteExecCall ["life_fnc_wantedAdd",RSERV];
};
